...
return (
    <div className=' flex items-center justify-between bg-[#2772a0] h-[10vh] rounded-md'>
        ...
        <div className='p-2 flex items-center gap-4 justify-end w-full'>
            ...
            <div className='bg-blue-100 rounded-sm items-center justify-center flex p-2 cursor-pointer relative'>
            ...
            <div className='rounded-sm items-center justify-between gap-2 flex p-[1px] cursor-pointer'>
                <div className='flex flex-col'>
                    ...
                    <div className=' rounded-sm bg-blue-100 flex items-center justify-center lg:w-[4vw] md:w-[6vw] w-[10vw]'>
