      ...
      <div className="p-6 bg-white mt-[2vh] rounded-md">
        ...
        >
          ...
          <div className="flex items-center space-x-3 my-8">
            ...
            <FileText className="w-6 h-6 text-blue-50" />
            </div>
            <h1 className="text-2xl font-bold tracking-tighter text-zinc-800">Payslip</h1>
          </div>
        ...
        {!showPreview ? (
          <>
            ...
            <div className="bg-[#1f435b] p-6 rounded-lg shadow-sm border mb-6">
              <h3 className="text-lg font-medium text-zinc-50 mb-4">Payslip Configuration</h3>
            ...
            <div className="bg-white shadow rounded-lg overflow-hidden mb-6">
              <div className="px-6 py-4 border-b border-zinc-200">
                <h3 className="text-lg tracking-tight text-zinc-800 font-medium capitalize">
            ...
            <div className="bg-[#1f435b] p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-medium text-zinc-50">Generate Payslip</h3> 
                  <p className="text-sm text-white mt-1">
                    {selectedEmployee ? 
                      `Payslip for ${getMonthLabel(selectedMonth)}` :
