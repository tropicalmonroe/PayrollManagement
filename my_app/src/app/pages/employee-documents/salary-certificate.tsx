      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Salary Certificate</h1> 
          </div>
        ...
        {!showPreview ? (
          <>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border mb-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Certificate Configuration</h3> 
            ...
            {selectedEmployee && (
              <div className="bg-white p-6 rounded-lg shadow-sm border mb-6">
                <h3 className="text-lg font-medium text-gray-900 mb-4">Certificate Content</h3>
          ...
          <>
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="p-8">
                ...
                <div className="mb-8">
                  <h3 className="font-medium text-gray-900 mb-4">Employee Information</h3> 
                ...
                <div className="text-right">
                  <div className="inline-block">
                    <div className="text-sm text-gray-600 mb-2">Issued in Nairobi, on {formatDate(certificateData.generatedDate)}</div> 
                    <div className="border-t border-gray-300 pt-4 mt-8">
                      <div className="text-sm font-medium text-gray-900">Employer’s Signature and Stamp</div>
                    </div>
                  </div>
                </div>
              </div>
