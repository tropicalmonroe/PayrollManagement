...
const simulationModules = [
    ...
    icon: Calculator,
    href: '/pages/simulation/salary-simulation',
    color: 'blue',
    ...
    icon: Users,
    href: '/pages/simulation/family-tax-impact',
    color: 'green',
    ...
    icon: TrendingUp,
    href: '/pages/simulation/regularization-recall',
    color: 'purple',
    ...
    icon: Home,
    href: '/pages/simulation/housing-credit',
    color: 'orange',
...
return (
    <div className="space-y-6 bg-white mt-[2vh] rounded-md p-6">
    <div className='my-8'>
        <h2 className="text-2xl font-bold tracking-tighter text-zinc-800">Simulation</h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 ">
        <div className="bg-[#1f435b] overflow-hidden shadow rounded-lg">
        <div className="p-5">
            <div className="flex items-center">
            <div className="flex-shrink-0 p-1 w-10 h-10 bg-white rounded-xl flex items-center justify-center">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        return (
            <div
            key={module.id}
            className={`${colorClasses.bg} ${colorClasses.border} border rounded-lg p-6 hover:scale-105 transition ease-in-out duration-300 cursor-pointer`}
            >
            <div className="flex items-start justify-between">
                ...
                <div className="ml-4">
                    <h3 className={`text-xl font-semibold tracking-tighter ${colorClasses.title}`}>
                    {module.title}
                    </h3>
                    <p className="mt-1 text-sm text-zinc-600 tracking-tight w-[22vw]">
                    {module.description}
                    </p>
                </div>
                </div>
