            ...
            <div className="bg-[#1f435b] p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  disabled={generating}
                  className="flex items-center justify-center cursor-pointer w-fit px-4 py-2 text-white hover:text-black bg-blue-500
                            rounded-md hover:bg-blue-200 transition duration-300 ease-in-out"
                >
                  <BookOpen className="w-5 h-5 mr-2 mt-[2px]" />
