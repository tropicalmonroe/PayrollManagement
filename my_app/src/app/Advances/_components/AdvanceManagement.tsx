...
const getStatusBadge = (status: AdvanceStatus) => {
    ...
    CANCELLED: { color: 'bg-rose-100 text-rose-800', icon: AlertCircle, text: 'Cancelled' }
    };
...
return (
    ...
    <div className="space-y-6 p-6 bg-white mt-[2vh] rounded-md">
        ...
        <div>
            <h1 className="text-2xl font-bold text-zinc-800 tracking-tighter">Salary Advance Management</h1>
        ...
        <div className="mt-4 sm:mt-0">
            ...
            className="flex items-center space-x-2 text-sm cursor-pointer bg-emerald-600 text-white px-4 
                py-2 rounded-lg hover:bg-emerald-200 hover:text-emerald-600 transition-colors duration-300 ease-in-out"
            >
        ...
        <div className="bg-[#2f5675] overflow-hidden shadow rounded-lg">
            ...
            <div className="flex items-center">
                ...
                <dl>
                    ...
                    <dd className="text-lg font-medium text-rose-400">
        ...
        {/* Filters */}
        <div className="bg-[#142b3d] shadow rounded-lg mt-[2vh]">
        <div className="px-6 py-4 border-b border-zinc-200">
            ...
            <div className="flex-1 max-w-lg">
                ...
                <input
                    type="text"
                    className="block w-full pl-10 pr-3 py-2 border border-zinc-300 rounded-md leading-5 bg-white 
                    placeholder-zinc-500 focus:outline-none focus:placeholder-zinc-400 focus:ring-1 focus:ring-[#0063b4] focus:border-[#0063b4] sm:text-sm"
            ...
            <div className="flex space-x-4">
                ...
                className="block w-full pl-3 pr-10 bg-white border border-zinc-300 
                focus:outline-none fpx-6 py-3 text-left text-xs font-medium uppercase tracking-wider 
                    text-zinc-800 cursor-pointer hover:bg-white transition-all duration-300 ease-in-out"
                >
        ...
        <div className="overflow-x-auto">
            ...
            <tbody className="bg-[#142b3d] divide-y divide-zinc-200">
                ...
                <tr key={advance.id} className="hover:bg-[#1b435b] transition duration-300">
                    ...
                    <div className="flex items-center">
                        <div className=''>
                        <div className="text-sm font-medium tracking-tight text-white mb-1">
                            {advance.employee.firstName} {advance.employee.lastName}
                        </div>
                        <div className="text-sm font-medium tracking-tight text-white scale-90 -ml-[8px] mb-1">
                            {advance.employee.employeeId} • {advance.employee.position}
                        </div>
                        <div className="text-sm font-medium tracking-tight text-emerald-400">
                    ...
                    <div className="text-xs font-medium tracking-tight text-white">
                        Remaining: <b className='text-rose-400'>{formatCurrency(advance.remainingBalance)}</b>
                    </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium tracking-tight text-white">
                    ...
                    {(() => {
                        ...
                        <div className="flex items-center">
                            ...
                            <span className={`text-sm font-medium tracking-tight ${progressInfo.isLate ? 'text-rose-600' : 'text-white'}`}>
                    ...
                    <div className="flex items-center justify-end space-x-2">
                        ...
                        className="flex items-center justify-center cursor-pointer w-8 h-8 bg-zinc-500
                ...
                <div className="flex items-end space-x-3">
                    ...
                    try {
                        const response = await fetch('/api/advances/update-progress', {
                            ...
                            body: JSON.stringify({
                                advanceId: selectedAdvance.id, // <-- correct key
                    ...
                    if (response.ok) {
                        ...
                        toast.error(`Error: ${error.error}`);
                            ...
                            toast.error('Error updating remaining balance');
                        } finally {
