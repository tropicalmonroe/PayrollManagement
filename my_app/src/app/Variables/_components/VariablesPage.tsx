    ...
    <>
        <div className="space-y-6 p-6 bg-white mt-[2vh] rounded-md">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-zinc-800 tracking-tight">Monthly Variable Elements</h2>
              <p className="mt-1 text-sm text-zinc-400 tracking-tighter w-[20vw]">
                Management of payroll variables: overtime, absences, bonuses, leaves, lateness, advances
              </p>
            </div>
            <button
              onClick={handleAddElement}
              className="inline-flex items-center px-4 py-2 bg-pink-500 border border-zinc-300 shadow-sm text-sm font-medium 
            rounded-md hover:text-zinc-700 text-white hover:bg-pink-200 hover:cursor-pointer 
          ...
          {/* Filters */}
          <div className="bg-[#1f435b] rounded-lg shadow-sm border border-zinc-200 p-6">
            <h3 className="text-lg font-medium text-white tracking-tight mb-4">Filters</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
              <div>
                ...
                <select
                  ...
                  className="block w-full px-3 py-2 border border-zinc-300 rounded-md shadow-sm 
                  focus:outline-none focus:ring-[#0063b4] 
                  focus:border-[#0063b4] sm:text-sm bg-white"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="block w-full px-3 py-2 border border-zinc-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-[#0063b4] focus:border-[#0063b4] sm:text-sm"
                >
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Search className="h-5 w-5 text-zinc-400/80" />
                  </div>
                  <input
                    type="text"
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="block w-full pl-10 pr-3 py-2 border border-zinc-300 bg-white
                      rounded-md shadow-sm focus:outline-none focus:ring-[#0063b4] 
                      focus:border-[#0063b4] sm:text-sm placeholder:text-zinc-700/50 placeholder:text-sm 
                      placeholder:font-medium placeholder:tracking-tight"
          ...
          <div className="bg-white rounded-lg shadow-sm border border-zinc-200">
            <div className="px-6 py-4 border-b border-zinc-200">
              <h3 className="text-lg font-medium text-zinc-800 tracking-tight">
                Variable Elements <strong>({filteredElements.length})</strong>
              </h3>
            </div>
                ...
                <table className="min-w-full divide-y divide-zinc-200">
                  <thead className="bg-[#2f5675]">
                    ...
                    text-white cursor-pointer hover:bg-zinc-800 transition-all duration-300 ease-in-out">
                      ...
                      <th className="ppx-6 py-3 text-left text-xs font-medium uppercase tracking-wider 
                    text-white cursor-pointer hover:bg-zinc-800 transition-all duration-300 ease-in-out">
                        Actions
                      </th>
                    </tr>
                  ...
                  <tbody className="bg-[#142b3d] divide-y divide-zinc-200">
                    {filteredElements.map((element) => (
                      <tr key={element.id} className="hover:bg-[#1b435b] transition duration-300">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-8 w-8">
                              <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center">
                                <span className="text-xs font-medium text-blue-600 tracking-tight">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 flex items-center justify-center h-8 w-8 p-1 rounded-full bg-white">
                            {getTypeIcon(element.type)}
                            </div>
                            <span className="ml-2 text-sm tracking-tight text-white">
                              {getTypeLabel(element.type)}
                            </span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="text-sm tracking-tight text-white">{element.description}</div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <div className="flex items-center justify-end space-x-2">
                            <button
                              ...
                              title='Edit'
                              className="flex items-center justify-center cursor-pointer w-8 h-8 bg-emerald-500
                            ...
                            <button
                              ...
                              className="flex items-center justify-center cursor-pointer w-8 h-8 bg-rose-500
                              rounded-md p-1 hover:bg-blue-200 transition duration-300 ease-in-out"
                              title="Delete"
                          >
